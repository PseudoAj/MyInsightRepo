...
class Water():
    ...
    def readAll(self):
        ...
        try:
            ...
            # Debug statement
            print "Water: Completed reading files."
        ...
        while curTime < self.endTime:
            ...
            if int(curStrTime) in self.timeDataDict:
                ...
                for curSrvceId in curSrvceList:
                    ...
                    curRcrdRow = self.genWtrRow(curRcrdDict,int(curStrTime),int(newTimeStmp))
...
if __name__ == '__main__':
    ...
    # Initialize the class
    thisWtrProdcr =  Water(dur,intrvl,addr)

    # Start the producer method
    thisWtrProdcr.produce()
