...
#title           :stream.py
#description     :The class is for sending streaming events
#                 The way the class is written is that it truggers three threads
...
if __name__ == '__main__':
    ...
    # Get the address for kafka
    print "#====================#"
    print "please enter kafka address(ex: 172.31.0.232):"
    ipAddr = str(raw_input())

    # Initialize the main class with address
    thisEngne =  StreamEngine(numOfRegs,intrvl,duration,ipAddr)
