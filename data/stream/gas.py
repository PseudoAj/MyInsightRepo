...
class Gas():
    ...
    def readAll(self):
        ...
        try:
            ...
            # Debug statement
            print "Gas: Completed reading files."
        ...
        while curTime < self.endTime:
            ...
            if int(curStrTime) in self.timeDataDict:
                ...
                for curSrvceId in curSrvceList:
                    ...
                    curRcrdRow = self.genGasRow(curRcrdDict,int(curStrTime),int(newTimeStmp))
...
if __name__ == '__main__':
    ...
    # Initialize the class
    thisGasProdcr =  Gas(dur,intrvl,addr)

    # Start the producer method
    thisGasProdcr.produce()
