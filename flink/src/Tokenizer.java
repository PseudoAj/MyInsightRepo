 ...
 *description     :he java program is for tokenizing the streaming data
...
public class Tokenizer implements FlatMapFunction<String, Tuple3<Long, String, Double>> {
    ...
    public void flatMap(String rcrd, Collector<Tuple3<Long,String, Double>> collector) throws Exception {
        ...
        collector.collect(new Tuple3<Long,String, Double>(Long.parseLong(tkns[6]),tkns[0],Double.parseDouble(tkns[5])));
    }
}
